  ...
  return (
    <section className="hero-section">
      <div className="hero-content z-10">
        ...
        <h1 className="text-6xl md:text-6xl font-bold tracking-tighter leading-[0.8]">
        ...
        {/* Subtitle */}
        <p className="text-lg font-semibold text-slate-700 max-w-md leading-relaxed">
        ...
        {/* Stats section */}
        <div className="flex items-center gap-8 border-t border-slate-200/80 pt-6 w-full">
          <div className="flex flex-col gap-1">
            <span className="text-2xl font-bold text-slate-800">90-Day</span>
            <span className="text-[10px] uppercase tracking-widest text-slate-600 font-bold">
              Full Warranty
            </span>
          </div>
          <div className="w-px h-8 bg-slate-100/80"></div>
          <div className="flex flex-col gap-1">
            <span className="text-2xl font-bold text-slate-800">45min</span>
            <span className="text-[10px] uppercase tracking-widest text-slate-600 font-bold">
              Avg Fix Time
            </span>
          </div>
